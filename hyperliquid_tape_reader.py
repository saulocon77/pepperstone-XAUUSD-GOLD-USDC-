#!/usr/bin/env python3
"""
Hyperliquid — Monitor HYPE (perp): tape, Z-score dinámico, CVD institucional, funding, leaderboard.

Mercado fijo: perpetuo HYPE.
...
async def main_async() -> None:
    ...
    log.info(
        "HYPE Smart Money Monitor | WS=%s | WS_MAX_AGE=%ss | resumen cada %ss | leaderboard cada %ss",
        WS_URL,
        WS_MAX_AGE_SEC,
        SUMMARY_INTERVAL_SEC,
